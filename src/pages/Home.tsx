      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-serif font-bold tracking-tight text-primary mb-6">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              ...
              <h3 className="text-3xl md:text-4xl font-serif font-bold tracking-tight text-primary mb-8">
                What Our Patients Are Saying
              </h3>
              <div className="flex space-x-12 mb-10">
                <div className="flex flex-col">
                  <span className="text-2xl font-serif text-accent mb-1">98%</span>
                  <span className="text-xs uppercase tracking-widest text-foreground/50 font-bold">Patient Satisfaction</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl font-serif text-accent mb-1">5.0</span>
            ...
            <div className="lg:w-1/2 w-full">
              <div className="bg-background p-10 rounded-2xl shadow-xl relative">
                ...
                <p className="text-lg md:text-xl font-serif italic text-primary leading-relaxed mb-8">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                <Link to="/consultation" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full bg-accent hover:bg-accent/90 text-white rounded-full px-10 py-6 text-base font-bold">
                    Book Consultation Now
                  </Button>
                </Link>
                <Link to="/contact" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full border-white/20 text-white hover:bg-white/10 rounded-full px-10 py-6 text-base font-bold">
                    Visit Our Clinic
                  </Button>
                </Link>
              </div>
